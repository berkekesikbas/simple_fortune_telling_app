...
class AskFaliSonucu extends StatefulWidget {
  const AskFaliSonucu({Key key}) : super(key: key);

  @override
  _AskFaliSonucuState createState() => _AskFaliSonucuState();
}

class _AskFaliSonucuState extends State<AskFaliSonucu> {
  List falSonuclariDB;
  ...
  void askFaliJsonOku() async {
    String okunanFal = await DefaultAssetBundle.of(context).loadString('assets/data/ask_fali.json');
    ...
    String gosterilecekFalSonucu = falSonuclari[rastgeleSayi]['fal_sonucu'].toString();
    setState(() {
